...
void sortData()
{
  ...
  else if (str_buffer.substring(3, 4) == "T")
  {
    ...
    displayTime(timeValue / 10, timeValue % 10, 6, 24, 1);
  }
...
void displayTime(int timeValueInt, int timeValueDec, int startx, int starty, int timerColour)
{
  ...
  {
    if (timeValueInt >= 10 && timeValueInt < 20)
    {
      // Plot starting at corect value
      mySerial.print("text ");
      mySerial.print(timerColour);
      mySerial.print(' ');
      mySerial.print(startx + 13);
      mySerial.print(' ');
      mySerial.print(starty);
      mySerial.print(' ');
      mySerial.print('"');
  ...
  {
    if (timeValueInt >= 100 && timeValueInt < 200)
    {
      mySerial.print("text ");
      mySerial.print(timerColour);
      mySerial.print(' ');
      mySerial.print(startx + 2);
      mySerial.print(' ');
      mySerial.print(starty);
      mySerial.print(' ');
      mySerial.print('"');
